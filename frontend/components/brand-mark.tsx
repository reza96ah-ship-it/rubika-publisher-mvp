...
export function WorkspaceAvatar({
  ...
  return (
    <span className={`relative inline-flex shrink-0 items-center justify-center bg-app-tealSoft text-[10px] font-black text-app-teal shadow-hairline ${sizeClasses[size]} ${className}`}>
      {initials(name)}
