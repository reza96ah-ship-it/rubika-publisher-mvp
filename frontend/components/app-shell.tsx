            ...
            <div className="flex min-h-[58px] items-center justify-between gap-3 px-3 py-2 lg:px-5">
              ...
              <div className="flex min-w-0 items-center gap-2">
                ...
                >
                  ...
                  <span className="mr-auto hidden rounded border border-app-border bg-app-surfaceMuted px-1.5 py-0.5 text-[10px] font-bold text-app-muted xl:inline">Ctrl K</span>
                </button>
                ...
                >
                  ...
                  <span className={`absolute bottom-1 right-1 h-1.5 w-1.5 rounded-full ring-2 ring-app-surface ${liveNotificationsReady ? "bg-emerald-500" : "bg-slate-300"}`} aria-label={liveNotificationsReady ? "اعلان زنده فعال" : "اعلان زنده در حال اتصال"} />
                  {notificationCount ? (
                ...
                <div className="relative">
                  ...
                  {accountMenuOpen ? (
                    <div className="app-popover app-studio-panel absolute left-0 top-11 w-64 overflow-hidden rounded-lg">
                      ...
                      <div className="p-1.5">
                        <Link href="/store" className="app-interactive flex items-center gap-2 rounded px-2.5 py-2 text-xs font-bold text-app-text hover:bg-app-surfaceMuted">
                          <Settings2 className="h-3.5 w-3.5" aria-hidden="true" />
                          تنظیمات فضای کاری
                        </Link>
                        <Link href="/channels" className="app-interactive flex items-center gap-2 rounded px-2.5 py-2 text-xs font-bold text-app-text hover:bg-app-surfaceMuted">
