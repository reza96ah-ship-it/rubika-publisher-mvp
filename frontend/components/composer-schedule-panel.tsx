      ...
      <div className="rounded-md border border-app-border bg-white p-3">
        ...
        <div className="mt-2 grid grid-cols-7 gap-1">
          {dayCells.map((day, index) => {
            ...
            const classes = selected ? "bg-slate-950 text-white shadow-sm" : today ? "bg-emerald-50 text-emerald-700 ring-2 ring-emerald-200" : "bg-slate-50 text-slate-700 hover:bg-blue-50 hover:text-app-primary";
            return (
