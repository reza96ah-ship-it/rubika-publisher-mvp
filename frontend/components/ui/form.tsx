...
const controlClassName =
  "w-full rounded-md border border-app-border bg-white px-3.5 py-2.5 text-sm text-app-text outline-none transition placeholder:text-slate-400 focus:border-app-primary focus:ring-2 focus:ring-blue-100 disabled:bg-slate-50 disabled:text-slate-400";
