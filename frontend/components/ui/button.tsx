...
export function Button(props: ButtonProps) {
  ...
  const classes = [
    "app-interactive inline-flex items-center justify-center rounded-md font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-100 disabled:pointer-events-none disabled:opacity-60",
