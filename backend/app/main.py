...
for router in [auth_router, stores_router, rubika_router, instagram_router, campaigns_router, posts_router, media_router, publish_attempts_router, notifications_router]:
